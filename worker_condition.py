...
with open('image_caption.json') as json_file: 
    image_caption_dict = json.load(json_file) 
  
    # Print the type of data variable 
    print("Type:", type(image_caption_dict))

for image,caption in image_caption_dict.items():
    print("Image: ",image, "Caption: ",caption)
    # if not os.path.isabs(image):
    #     image_path = os.path.abspath(image)
    #     print(f"Loading image from : {image_path}")
    demo_manager.set_condition(image,caption)

demo_manager.save_condition()
